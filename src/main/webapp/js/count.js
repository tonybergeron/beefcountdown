...
$.fn.countdown = function( method /*, options*/ ) {
	...
	var defaults = {
			date: null,
			updateTime: 1E3,
			htmlTemplate: "<span class='digets'>%d</span><span class='cd-time'> : </span> <span class='digets'>%h</span> <span class='cd-time'> : </span> <span class='digets'>%i</span> <span class='cd-time'> : </span> <span class='digets'>%s</span> <span class='cd-time'></span>",
			minus: false,
			onChange: null,
			onComplete: null,
			onResume: null,
